...
class SPlusBot:
    ...
    def euclidean_distance(self, goal_pose):
        ...
        return sqrt(pow((goal_pose.x - self.position.x), 2) +
                    pow((goal_pose.y - self.position.y), 2))
    ...
    def steering_angle(self, goal_pose):
        """See video: https://www.youtube.com/watch?v=Qh15Nol5htM."""
        return atan2(goal_pose.y - self.position.y, goal_pose.x - self.position.x)

    def angular_vel(self, goal_pose, constant=0.005):
        """See video: https://www.youtube.com/watch?v=Qh15Nol5htM."""

        return constant * (self.steering_angle(goal_pose) - self.position.theta.toTheta())
